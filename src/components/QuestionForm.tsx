...
const LabelInputContainer = ({
    ...
    return (
        <div
            className={cn(
                "relative flex w-full flex-col space-y-2 overflow-hidden rounded-xl border border-white/12 bg-gradient-to-br from-black via-zinc-950 to-slate-950 p-4 shadow-[0_20px_60px_rgba(0,0,0,0.35)]",
                className
            )}
        >
            <Meteors number={30} />
...
const QuestionForm = ({ question }: { question?: QuestionDocument }) => {
    ...
    const create = async () => {
        ...
        const response = await databases.createDocument(db, questionCollection, ID.unique(), {
            ...
            attachmentId: storageResponse?.$id || null,
        });
        ...
        try {
            ...
            setError(() =>
                error instanceof AppwriteException || error instanceof Error
                    ? error.message
                    : "Something went wrong while publishing your question"
            );
        }
    ...
    return (
        <form className="space-y-4" onSubmit={submit}>
                ...
                <div className="flex w-full gap-4">
                    ...
                    <button
                        ...
                        onClick={() => {
                            ...
                            setFormData(prev => ({
                                ...prev,
                                tags: new Set([...Array.from(prev.tags), normalizedTag]),
                            }));
                            setTag(() => "");
                        }}
                    >
            ...
            <button
                ...
                disabled={loading}
            >
                {loading ? (question ? "Updating..." : "Publishing...") : question ? "Update" : "Publish"}
            </button>
        </form>
    );
};
